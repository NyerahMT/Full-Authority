...
def write_include(dem: np.ndarray) -> None:
    ...
    with OUT_INC.open("w", encoding="utf-8") as handle:
        ...
        handle.write(f"static constexpr double kFAStage022TerrainMinXMeters = {MIN_X_M:.6f};\n")
        handle.write(f"static constexpr double kFAStage022TerrainMaxXMeters = {MAX_X_M:.6f};\n")
        handle.write(f"static constexpr double kFAStage022TerrainMinZMeters = {MIN_Z_M:.6f};\n")
        handle.write(f"static constexpr double kFAStage022TerrainMaxZMeters = {MAX_Z_M:.6f};\n")
